...
bool LTexture::loadFromFile( std::string path )
{
    ...
    else
    {
        ...
        else
        {
            ...
            std::cout << "cur mWidth =" << mWidth << ",mHeight=" << mHeight <<"\n";//320 240
        }
...
bool init()
{
    ...
    else
    {
        ...
        if( SDL_CreateWindowAndRenderer( "SDL3 Tutorial: Key Presses and Key States", kScreenWidth, kScreenHeight, 0, &gWindow, &gRenderer ) == false )
        {
